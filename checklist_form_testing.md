...
---|---|---|---|---|---|---|---
__Name__
1	|Ввести 10 латинских букв	|Остальные поля заполнены валидными данными	|Sergeyqaqa	|Success|	|	pass	
2|	Ввести 1 латинскую букву	|Остальные поля заполнены валидными данными|	S	|Error	|	|pass|	
3|	Ввести 2 латинские буквы	|Остальные поля заполнены валидными данными|	Se	|Success|	Error|	fail	|id_1
4|	Ввести 3 латинские буквы	|Остальные поля заполнены валидными данными|	Ser	|Success|	Error	|fail|	id_2
...
8|	Ввести имя и добавить цифры в начале|	Остальные поля заполнены валидными данными|	123Sergey	|Success|		|pass	
9|	Ввести имя и добавить цифры в конце|Остальные поля заполнены валидными данными	|	Sergey123	|Success|		|pass	
10|	Добавить в имя разрешенные спецсимволы|Остальные поля заполнены валидными данными	|	S e-r g.e y	|Success	||	pass	
11|	Ввести только цифры	|Остальные поля заполнены валидными данными|	12345|	Success	|	|pass|	
12|	Добавить в имя запрещенные спецсимволы|Остальные поля заполнены валидными данными|		S&ergey|	Error|	Success	|fail|	id_5|
13|	Написать имя в нижнем регистре|	Остальные поля заполнены валидными данными	|Sergey	|Success	|	|pass|	
14|	Написать имя в верхнем регистре|Остальные поля заполнены валидными данными	|	SERGEY|	Success		||pass|	
15|	Оставить поле пустым	|Остальные поля заполнены валидными данными|	|	Error	||	pass	
16|	Заполнить кириллицей	|Остальные поля заполнены валидными данными|	Сергей|	Error	|Success	|fail|	id_6
17|	Скопировать и вставить в форму с помощью клавиатуры в форму	|Остальные поля заполнены валидными данными|	Sergey|	Success	||	pass	
18|	Скопировать и вставить в форму с помощью мыши в форму|Остальные поля заполнены валидными данными|		Sergey	|Success	||	pass	
...
21|	Провести регистрацию с тем же именем |Остальные поля заполнены валидными данными|		Sergey|	Success	||	pass	
22|	Ввести имя с разрешенного спецсимвола|Остальные поля заполнены валидными данными|		_Sergey|	Error|	Success|	fail|	id_7
23|	Поставить разрешенный спецсимвол в конце|Остальные поля заполнены валидными данными|		Sergey_|	Error|	Success|	fail|	id_8
24|	Обновить страницу|Остальные поля заполнены валидными данными	|	Sergey|	Имя исчезло	|	|pass	
25|	Ввести имя и в середине поставить разрешенный спецсимвол 2 раза	|Остальные поля заполнены валидными данными|	Sergey__kono|	Error|	Success|	fail|	id_9
...
30|	Ввести только разрешенные спецсимволы|Остальные поля заполнены валидными данными	|	_._-|	Error	|Success|	fail|	id_11
...
63|	Ввести от @ до точки валидное колличество символов с использованием цифр|Остальные поля заполнены валидными данными|		ert123@123gmail.com|	Success	||	pass	
...
96|	Только в нижнем регистре|Остальные поля заполнены валидными данными|		qwertyuiop|	error|	Success|	fail	|id_40
